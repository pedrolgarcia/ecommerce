<?php
    ...
    class Category extends Model {
        ...
        public function getProductsPage($page = 1, $itemsPerPage = 3)
        {
            ...
            $sql = new Sql();
            $results = $sql->select("SELECT SQL_CALC_FOUND_ROWS * FROM tb_products a INNER JOIN tb_productscategories b
                ON a.idproduct = b.idproduct INNER JOIN tb_categories c ON c.idcategory = b.idcategory
