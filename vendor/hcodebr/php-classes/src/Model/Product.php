<?php
    ...
    class Product extends Model {
        ...
        {
            $sql = new Sql();
            $res = $sql->select("CALL sp_products_save(:idproduct, :desproduct, :vlprice, :vlwidth, :vlheight,
        ...
        public function checkPhoto()
        {
            ...
            DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR . "products" . DIRECTORY_SEPARATOR . 
